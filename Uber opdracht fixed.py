...
# Deze string is onnodig sinds de volgende string direct hierna ook al aangeeft hoeveel KM de gebruiker heeft ingevoerd
# print(f"U heeft {afstand}KM ingevoert")
